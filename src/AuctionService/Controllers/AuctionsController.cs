...
public class AuctionsController : ControllerBase
{
    ...
    public async Task<ActionResult<List<AuctionDto>>> GetAllAuctions(string date)
    {
        ...
        return await query
            .ProjectTo<AuctionDto>(_mapper.ConfigurationProvider) // provide the mapper config to let it know where to get the mapping profile for this query
            .ToListAsync();
    }
    ...
    public async Task<ActionResult<AuctionDto>> CreateAuction(CreateAuctionDto auctionDto)
    {
        ...
        // User object that contains an identity object that will contain our name claim
